...
#The two analyses do seem to compliment each other.  The cca shows that moisture is linear in its effect, which seems to compliment the indirect ordination.  The indirect ordination shows that moisture is related to site of the plants, and in that way a similarly linear relationship.  
